...
ax1.plot(range(1,noHeadToss+1),wins,color='blue',label='Winnings')
ax1.scatter(range(1,noHeadToss+1),wins,color='blue')
ax1.grid()
ax2 = ax1.twinx()
ax2.set_ylabel('Probability of Win [%]')
ax2.plot(range(1,noHeadToss+1),100*pWin,color='green',label='Probability')
ax2.scatter(range(1,noHeadToss+1),100*pWin,color='green')
fig.tight_layout()
